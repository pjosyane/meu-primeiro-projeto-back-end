...
const router = express.Router() // aqui configurei a primeira parte da rota
const cors = require ('cors') // estou trazendo pacote cor que permite o consumo da api no frony

const conectaBancoDeDados = require ('./bancoDeDados') // aqui estou ligando ao arquivo banco de dados
conectaBancoDeDados () // aqui estou chamando a função
